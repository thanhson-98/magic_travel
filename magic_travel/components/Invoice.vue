      ...
      <div class="row justify-center">
        <div class="col-xl-10 col-lg-11">
          <div class="d-flex justify-end">
            <button @click='handlePrintClick' class="button -md -dark-1 bg-accent-1 text-white">
              Print
              <i class="icon-print text-20 ml-10"></i>
            </button>
          </div>
          ...
          <div class="bg-white rounded-4 mt-50">
              ...
              <div class="row justify-between">
                ...
                <div class="col-xl-4">
                  <div class="row justify-between items-center">
                    <div class="col-auto">
                      <div class="text-26 fw-600">Invoice #</div>
                    </div>

                    <div class="col-auto">
                      <div class="text-18 fw-500">0043128641</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="border-1-top py-40">
              <div class="row x-gap-60 y-gap-10 justify-center">
                <div class="col-auto">
                  <a href="#" class="text-14"> www.tourz.com </a>
                </div>
                <div class="col-auto">
                  <a href="#" class="text-14"> invoice@tourz.com </a>
                </div>
                <div class="col-auto">
                  <a href="#" class="text-14"> (123) 123-456 </a>
                </div>
              </div>
            </div>
          </div>
