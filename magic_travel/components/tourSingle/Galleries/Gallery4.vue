<template>
  <section class="tourSingleHero5">
    <div class="tourSingleHero5__image">
      <div class="js-section-slider">
        <div class="swiper-wrapper" :style="{ height: '796px' }">
          <Swiper
            :space-between="10"
        ...
        <div class="navTourSingle">
          <button
            class="navTourSingle__button bg-white js-slider1-prev js-slider1-prev9"
          >
            <i class="icon-arrow-left text-14"></i>
          </button>

          <button
            class="navTourSingle__button bg-white js-slider1-next js-slider1-next9"
          >
      ...
      <div class="row">
        <div class="col-lg-8">
          <div class="row x-gap-10 y-gap-10 items-center">
            <div class="col-auto">
              <button
                class="button -accent-1 text-14 py-5 px-15 bg-white text-accent-1 rounded-200"
              >
                Bestseller
              </button>
            </div>
          ...
          <h2 class="text-40 sm:text-30 lh-14 text-white mt-20">
            {{ tour?.title.split(" ").slice(0, 7).join(" ") }}
            <br />
            {{ tour?.title.split(" ").slice(7).join(" ") }}
          </h2>

          <div class="row y-gap-20 justify-between items-center pt-20">
            <div class="col-auto">
            ...
            <div class="col-auto">
              <div class="d-flex x-gap-30 y-gap-10">
                <a href="#" class="d-flex items-center text-white">
