      ...
      <div class="layout-pt-xl layout-pb-xl rounded-12">
        ...
        <div class="row y-gap-30 justify-center items-center">
          <div class="col-lg-4 col-md-6">
            <h2 data-aos="fade-up" data-aos-delay="" class="text-40 lh-13">
              We Make
              <br class="md:d-none" />
              World Travel Easy
            </h2>

            <p data-aos="fade-up" data-aos-delay="" class="mt-10">
          ...
          <div class="col-md-6">
            <div data-aos="fade-left" data-aos-delay="" class="featuresGrid">
              <div
                v-for="(elm, i) in featuresTwo"
                :key="i"
                class="featuresGrid__item px-40 py-40 text-center bg-white rounded-12"
              >
                <nuxt-img
                  width="60"
                  height="60"
