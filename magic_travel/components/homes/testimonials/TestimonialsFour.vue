<template>
  <section class="layout-pt-xl layout-pb-xl bg-light-3">
    <div class="container">
      ...
      <div class="row justify-center pt-60 md:pt-30">
        <div class="col-lg-8 col-md-9">
          <div class="overflow-hidden js-testimonialsSlider_1">
            <div data-aos="fade-up" data-aos-delay="" class="swiper-wrapper">
              ...
              >
                <SwiperSlide v-for="(elm, i) in testimonialsThree" :key="i">
                  <div class="testimonials -type-2 text-center">
                    ...
                    <div class="text-20 lh-18 md:text-18 fw-500 mt-60 md:mt-30">
                      {{ elm.comment }}
                    </div>

                    <div class="mt-60 md:mt-30">
                      <div class="text-16 fw-500 lh-14">{{ elm.name }}</div>
                      <div class="lh-14">{{ elm.role }}</div>
                    </div>
                  </div>
                </SwiperSlide>
              </Swiper>
        ...
        <div class="col-12">
          <div
            data-aos="fade-up"
            data-aos-delay=""
            class="testimonialsPagination -type-2 -blue pt-30 testimonialsSlider_2-pagination js-testimonialsSlider_1-pagination"
          >
            <div
              v-for="(elm, i) in testimonialsThree"
              :key="i"
