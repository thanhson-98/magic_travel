    ...
    <div class="container">
      ...
      <div class="relative pt-40 sm:pt-20">
        ...
        >
          <div class="swiper-wrapper">
            <Swiper
              :space-between="30"
              class="w-100"
              :navigation="{ prevEl: '.pbp3', nextEl: '.pbn3' }"
              :modules="[Navigation]"
              :breakpoints="{
                500: { slidesPerView: 1 },
                768: { slidesPerView: 2 },
        ...
        <div class="navAbsolute">
          <button class="navAbsolute__button bg-white js-slider1-prev pbp3">
            <i class="icon-arrow-left text-14"></i>
          </button>

          <button class="navAbsolute__button bg-white js-slider1-next pbn3">
