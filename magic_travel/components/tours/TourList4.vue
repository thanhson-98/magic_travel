...
import { speedFeatures } from "@/data/tourFilteringOptions"; // Update the path accordingly
import { tourDataTwo } from "@/data/tours"; // Update the path accordingly
import Sidebar2 from "./Sidebar2.vue"; // Update the path accordingly
