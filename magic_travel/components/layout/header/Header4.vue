  ...
  >
    <div class="header__container container">
      ...
      <div class="header__right">
        <div class="ml-30 dnStiky">
          <Currency />
        </div>

        <nuxt-link to="/help-center" class="text-white ml-20"> Help </nuxt-link>

        <nuxt-link to="/register" class="text-white ml-30"> Sign up </nuxt-link>

        <nuxt-link
          to="/login"
          class="button -sm -outline-white rounded-200 text-white ml-30"
        >
          Log in
        </nuxt-link>
        ...
        <nuxt-link
          to="/login"
          class="button size-42 -outline-white rounded-200 text-white ml-30"
        >
