<template>
    <section class="layout-pt-md layout-pb-lg mt-header">
      <div class="container">
        <div class="row">
          <div class="col-lg-8 bg-white rounded-12 shadow-2 py-15 px-20">
            <!-- Your existing code here -->
  
            <nuxt-link to="/login" class="text-accent-1">Sign in</nuxt-link>
            to book with your saved details or
            <nuxt-link to="/register" class="text-accent-1"> register</nuxt-link>
            to manage your bookings on the go!
  
            <div class="bg-white rounded-12 shadow-2 py-30 px-30 md:py-20 md:px-20 mt-30">
              <div v-if="bookingStage === 1">
              ...
              <div v-if="bookingStage === 3">
                <div class="d-flex flex-column items-center text-center">
                  ...
                  <h2 class="text-30 md:text-24 fw-700 mt-20">
              ...
              <h2 class="text-30 md:text-24 fw-700 mt-60 md:mt-30">
                Order Details
              </h2>
              ...
              <div class="container d-flex items-center justify-between w-100 mt-60" :style="{ maxWidth: '400px' }">
                <button @click="setBookingStage(bookingStage - 1)" class="button -md -dark-1 bg-accent-1 text-white"
                        :class="{ 'hiddenButtonBooking ButtonBooking': bookingStage === 1, 'ButtonBooking': bookingStage !== 1 }">
                  Previous
                </button>
  
                <button @click="setBookingStage(bookingStage + 1)" style="align-self: end"
                        class="button -md -dark-1 bg-accent-1 text-white"
                        :class="{ 'hiddenButtonBooking ButtonBooking': bookingStage === 3, 'ButtonBooking': bookingStage !== 3 }">
                  Next
                  <i class="icon-arrow-top-right text-16 ml-10"></i>
                </button>
              </div>
          ...
          <div class="col-lg-4">
            <!-- Your existing code for the right column here -->
          </div>
        </div>
      </div>
    </section>
  ...
  const bookingStage = ref(1);
  
  const setBookingStage = (stage) => {
    bookingStage.value = stage;
  };
  </script>
